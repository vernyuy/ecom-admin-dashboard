      ...
      <DashboardLayout>
        ...
        <nav className="flex sticky top-0 my-2" aria-label="Breadcrumb">
          ...
          <div className="sm:grid xl:grid-cols-4 min-[2000px]:grid-cols-5 lg:grid-cols-3 sm:grid-cols-2 flex-wrap p-5 gap-y-2 gap-x-4">
            <Panel bg={'#2081ba'} title={"Today's Orders"} figure={panel.todayOrders} url={'/orders'}>
              <svg xmlns="http://www.w3.org/2000/svg" className='my-auto w-16 h-16 text-black/30'  viewBox="0 0 24 24"><g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1"><path d="M3.977 9.84A2 2 0 0 1 5.971 8h12.058a2 2 0 0 1 1.994 1.84l.803 10A2 2 0 0 1 18.833 22H5.167a2 2 0 0 1-1.993-2.16l.803-10Z" /><path d="M16 11V6a4 4 0 0 0-4-4v0a4 4 0 0 0-4 4v5" /></g></svg>
            </Panel><Panel bg={'#07B61A'} title={"Total Revenue"} figure={`$${panel.totAmount}`} url={'/payments'}>
              <svg xmlns="http://www.w3.org/2000/svg" className='my-auto w-16 h-16 text-black/30' viewBox="0 0 24 24"><path fill="currentColor" d="M12 12.5a3.5 3.5 0 1 0 0 7a3.5 3.5 0 0 0 0-7ZM10.5 16a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0Z"/><path fill="currentColor" d="M17.526 5.116L14.347.659L2.658 9.997L2.01 9.99V10H1.5v12h21V10h-.962l-1.914-5.599l-2.098.715ZM19.425 10H9.397l7.469-2.546l1.522-.487L19.425 10ZM15.55 5.79L7.84 8.418l6.106-4.878l1.604 2.25ZM3.5 18.169v-4.34A3.008 3.008 0 0 0 5.33 12h13.34a3.009 3.009 0 0 0 1.83 1.83v4.34A3.009 3.009 0 0 0 18.67 20H5.332A3.01 3.01 0 0 0 3.5 18.169Z"/></svg>
            </Panel>
            <Panel bg={'#fcba03'} title={"Total Products"} url={'/products'} figure={panel.totProducts}>
              <svg
            ...
            <Panel bg={'#ba2027'} title={"Total Customers"} url={'/users'} figure={panel.totCustomers}>
              <svg xmlns="http://www.w3.org/2000/svg" className='my-auto w-16 h-16 text-black/30' viewBox="0 0 24 24"><path fill="currentColor" d="M24 14.6c0 .6-1.2 1-2.6 1.2c-.9-1.7-2.7-3-4.8-3.9c.2-.3.4-.5.6-.8h.8c3.1-.1 6 1.8 6 3.5zM6.8 11H6c-3.1 0-6 1.9-6 3.6c0 .6 1.2 1 2.6 1.2c.9-1.7 2.7-3 4.8-3.9l-.6-.9zm5.2 1c2.2 0 4-1.8 4-4s-1.8-4-4-4s-4 1.8-4 4s1.8 4 4 4zm0 1c-4.1 0-8 2.6-8 5c0 2 8 2 8 2s8 0 8-2c0-2.4-3.9-5-8-5zm5.7-3h.3c1.7 0 3-1.3 3-3s-1.3-3-3-3c-.5 0-.9.1-1.3.3c.8 1 1.3 2.3 1.3 3.7c0 .7-.1 1.4-.3 2zM6 10h.3C6.1 9.4 6 8.7 6 8c0-1.4.5-2.7 1.3-3.7C6.9 4.1 6.5 4 6 4C4.3 4 3 5.3 3 7s1.3 3 3 3z"/></svg>
            </Panel>
          </div>
