                      ...
                      {categories?.map((category: any, index: number) => {
                        return (
                          <tr key={category.id} className="even:bg-gray-50">
                            ...
                            <td className="p-4 text-sm font-normal text-gray-900 text-center whitespace-nowrap ">
                            ...
                            <td className="p-4 text-sm font-normal text-left text-gray-500 overflow-y-auto  h-fit w-fit">
