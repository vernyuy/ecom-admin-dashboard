...
import {
  ...
  filterCategories,
  listCategories,
} from "@/src/redux-store/feature/category/categorySlice";
      ...
      <main className="w-full h-full sticky top-0 overflow-y-hidden">
          ...
          <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
            ...
            <li>
              <div className="flex items-center">
                <svg
                  className="w-6 h-6 text-gray-400 dark:text-white/80"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <span
                  className="ml-1 text-gray-400 dark:text-white/80 md:ml-2 "
                  aria-current="page"
                >
                  Categories
                </span>
        ...
        <div className="px-2 mt-5 pb-2d bg-white w-full dark:bg-black rounded-ss-lg rounded-se-lg shadow-sm  sm:px-4 mt-f3 md:mt-5d">
          <div className="w-full">
            <div className="mb-2">
              <h1 className="text-md font-semibold text-gray-900 dark:text-white sm:text-xl  py-2 pt-4">
                All categories
              </h1>
            </div>
            <div className="items-center justify-between flex flex-col gap-2 sm:flex-row sm:flex-wrap md:divide-x md:divide-gray-100 pb-3">
                ...
                >
                  ...
                  <div className="relative w-full sm:w-64  xl:w-84">
                    <input
                      ...
                      id="products-search"
                      value={search}
                      className="bg-gray-50 outline-none dark:bg-transparent dark:text-white border border-gray-100 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 w-full py-1.5 px-2.5"
              ...
              <div className="flex border-none flex-wrap gap-2">
                <div className="group">
                  <Link
                    href={"#"}
                    className=" border text-green-500 dark:text-white font-semibold border-green-300 focus:ring-0 group-hover:text-white group-hover:border-none group-hover:bg-green-300 rounded-lg text-sm px-4 py-1.5 flex gap-1 items-center"
                    type="button"
                  >
                  ...
                  <div
                    id="dropdown"
                    className="z-10 hidden group-hover:block absolute bg-white dark:bg-black divide-y divide-gray-100 rounded-lg shadow w-fit -ml-3 "
                  >
                    <ul
                          ...
                          {categoryAttributes.map(
                            (item: string, index: number) => (
                              <th
                                key={index}
                                scope="col"
                                className="px-4 py-2 whitespace-nowrap dark:text-white text-left text-xs tracking-wider text-gray-900 font-bold uppercase "
                              >
                                {item}
                              </th>
                            ),
                            ...
                            >
                              ...
                              <td className="p-4">
                                {category.categoryImageUrl ? (
                                  ...
                                  <img className="h-1/2 w-1/2" src="/ddd.png" />
                                )}
                              </td>
                              ...
                              <td className="p-4 w-1/2 text-sm font-normal text-gray-500">
                              ...
                              <td className="p-4 flex justify-center">
                                {category.isParent ? (
                                  <p className="bg-green-100 whitespace-normal m-auto text-green-800 h-fit w-fit text-xs font-medium px-2.5 py-2 rounded-md ">
                                    True
                                  </p>
                                ) : (
                                  <p className="bg-orange-100 whitespace-normal m-auto text-orange-800 h-fit w-fit text-xs font-medium px-2.5 py-2 rounded-md ">
                                    false
                                  </p>
                                )}
                              </td>
      ...
      <CustomModal open={open} onClose={() => setOpen(false)}>
        <div className="text-center w-64">
          ...
          {selectedItems.length === 0 ? (
            ...
            <div>
              <p>
                Deleting this category will also delete products under this
                category.
              </p>
