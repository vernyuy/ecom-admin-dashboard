      ...
      <main className="w-full h-full sticky top-0 overflow-y-hidden">
        ...
        <div className="px-2 mt-5 pb-2d bg-white w-full  rounded-ss-lg rounded-se-lg shadow-sm  sm:px-4 mt-f3 md:mt-5d">
          <div className="w-full">
            <div className="mb-2">
              <h1 className="text-md font-semibold text-gray-900 sm:text-xl  py-2 pt-4">
                All categories
              </h1>
            </div>
            <div className="items-center justify-between flex flex-col gap-2 sm:flex-row sm:flex-wrap md:divide-x md:divide-gray-100 pb-3">
              ...
              <div className="flex border-none flex-wrap gap-2">
                <div className="group">
                  ...
                  <div
                    id="dropdown"
                    className="z-10 hidden group-hover:block absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-fit -ml-3 "
                  >
                    <ul
            ...
            <div className="overflow-x-autdfo w-full rounded-lg">
              <div className="inline-block min-w-full w-full align-middle">
                <div className="shadow sm:rounded-lg w-full">
                  {categories?.length !== 0 ? <table className="min-w-full divide-y divide-gray-200 mb-3">
                          ...
                          <tr key={category.id} className="even:bg-gray-50">
                            ...
                            <td className="p-4">
                              {category.categoryImageUrl ? (
                                <img className="h-full" src={category.categoryImageUrl} />
                              ) : (
