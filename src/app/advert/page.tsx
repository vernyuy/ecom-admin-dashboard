...
import { createCarousel, listCarousel, updateCarousel } from "@/src/redux-store/feature/store/storeSlice";
    ...
    <DashboardLayout>
      <main className="w-full h-fit sticky top-0 overflow-y-hidden">
        ...
        <div className="px-2 mt-5 pb-2d bg-white w-full  rounded-ss-lg rounded-se-lg shadow-sm  sm:px-4 mt-f3 md:mt-5d">
          ...
          {res.isLoading?<div className="w-full h-[100px] text-blue-500 flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="32"
                          height="32"
              ...
              {!carousel.status ? (
                ...
                >
                  ...
                  <div className="flex mt-8 justify-evenly">
                    ...
                    }} className="py-1 px-2 rounded-md border bg-red-500 hover:border-red-500 hover:text-white">Delete</button>
                  </div>
                </div>
                   </div>                 
                  )}
          ...
          </div> : <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
            {res.carousels?.map((carousel: any) => carousel.bannerUrl === null ? <></> : <div className="h- p-1 bg-black">
              <img src={carousel.bannerUrl} alt="" className="h-full w-full" key={carousel.id} />
            </div>)}
          </div>}
        </div>
      </main>
