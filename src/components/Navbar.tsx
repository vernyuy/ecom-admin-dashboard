  ...
  return (
    <nav className="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-black dark:text-white">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            {/* <button
              ...
              type="button"
              className="text-gray-500 hover:bg-gray-100 focus:ring-gray-200 dark:text-white rounded-lg text-sm p-2.5"
            >
              <svg
                id="theme-toggle-dark-icon"
                className="w-5 h-5 moon"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
      ...
      <div
        className={
          isShow
            ? "block min-h-[200px] border right-0 bg-white rounded-lg min-w-[200px] absolute"
            : "hidden"
        }
      >
        <div className="flex">
