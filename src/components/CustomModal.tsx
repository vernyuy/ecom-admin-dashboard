...
export interface customModalProps {
  ...
  errorMsg?: string,
  resetIsComplete: MouseEventHandler<HTMLButtonElement>
}
const CustomModal = ({isSuccess, msg, errorMsg, handleClick, resetIsComplete}:customModalProps) => {
  ...
  //   </div>}
    ...
    <div className={!isSuccess?"hidden":"overflow-hidden mx-auto z-[105]"}>
