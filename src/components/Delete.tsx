...
const Delete = ({ resetIsComplete, msg, item }: any) => {
  return (
          ...
          <div className="ease-in-out transition-all duration-700 p-2 pb-3 mb-5 mx-1 z-[105] h-fit w-[500px] bg-white rounded shadow">
            ...
            <div className="flex justify-center w-full">
              <button
                type="button"
                onClick={resetIsComplete}
                className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl  focus:outline-none font-medium rounded text-sm px-5 py-2.5 text-center mr-2 mb-2"
              >
                yes
              </button>
              <button
