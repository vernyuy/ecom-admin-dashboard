...
export declare type CategoryCreateFormValidationValues = {
    ...
    parentCategoryId?: ValidationFunction<string>;
    categoryImageUrl?: ValidationFunction<string>;
};
...
export declare type CategoryCreateFormOverridesProps = {
    ...
    parentCategoryId?: PrimitiveOverrideProps<TextFieldProps>;
    categoryImageUrl?: PrimitiveOverrideProps<TextFieldProps>;
} & EscapeHatchProps;
