...
export default function StoreUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setFontType(cleanValues.fontType);
    setHero(cleanValues.hero ?? []);
    setCurrentHeroValue("");
    setDescription(cleanValues.description);
    setOwnerEmail(cleanValues.ownerEmail);
    setOwnerAddress(
      typeof cleanValues.ownerAddress === "string" ||
        cleanValues.ownerAddress === null
        ? cleanValues.ownerAddress
        : JSON.stringify(cleanValues.ownerAddress)
    );
    setErrors({});
  };
